    ...
    <div class="container">
        <div class="tab-style-2 dark p-15px-t">
            <ul class="nav" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-05-tab" data-toggle="pill" href="#pills-05" role="tab" aria-controls="pills-05" aria-selected="false">
                        {{__('Virtual Card')}}
                    </a>
                </li>
            </ul>
                    ...
                    <div class="card border-top-0">
                        <div class="card-body p-10 p-lg-15">
                            ...
                            <div class="pxy-5">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">merchant_id <span class="text-default">int32</span> <span class="text-danger">required</span></label>
                                    <p>{{__('Business identification number.')}}</p>
                                </div>
                                </div>
                            </div>
                            <pre class="rounded mb-3">
                            ...
                            <pre class="rounded mb-3">
                                <code class="language-json" data-lang="json">
                                curl -X GET "{{url('/')}}/api/virtual_card/all/{merchant_id}" 
                                -H "Accept: application/json" 
                                -H "Authorization: Bearer {token}"
                                </code>
                            </pre>
