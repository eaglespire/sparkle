          ...
          <ul class="navbar-nav mb-3">
            ...
            <li class="nav-item">
              <a class="nav-link @if(route('user.chargeback')==url()->current()) active @endif" href="{{route('user.chargeback')}}">
                ...
                <span class="nav-link-text">{{__('Chargebacks')}}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link @if(route('user.profile')==url()->current() || route('user.security')==url()->current() || route('user.api')==url()->current() || route('user.beneficiary')==url()->current()) active @endif" href="{{route('user.profile')}}">
                <i class="fal fa-cog"></i>
                <span class="nav-link-text">{{__('Settings')}}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link @if(route('documentation.card')==url()->current() || route('documentation.intro')==url()->current() || route('user.documentation')==url()->current() || route('documentation.html')==url()->current() || route('documentation.js')==url()->current() || route('documentation.plugin')==url()->current()) active @endif" href="{{route('documentation.intro')}}">
    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <!-- Search form -->
          <h6 class="h2 fw-bold text-dark d-none d-sm-block">{{$title}}</h6>
          <!-- Navbar links -->
          ...
          <ul class="navbar-nav align-items-center">
            ...
            <span class="ml-0 text-md text-dark">{{__('Live')}}</span>
          </ul>
              ...
              <a class="nav-link pr-0" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body ml-2 d-none d-lg-block">
                    ...
                    <span class="mb-0 text-sm text-dark">Merchant ID: {{$user->business()->reference}}</span>
                  </div>
                </div>
              </a>
