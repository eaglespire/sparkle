                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if($val->status==1)
                                        <a class='btn btn-sm btn-success' href="{{route('plugin.unpublish', ['id' => $val->id])}}">{{ __('Unpublish')}}</a>
                                        @else
                                        <a class='btn btn-sm btn-success' href="{{route('plugin.publish', ['id' => $val->id])}}">{{ __('Publish')}}</a>
                                        @endif
                                    ...
                                    <div class="modal-body p-0">
                                        <div class="card bg-white border-0 mb-0">
                                            ...
                                            <div class="card-body px-lg-5 py-lg-5 text-right">
                                                ...
                                                <a href="{{route('plugin.delete', ['id' => $val->id])}}" class="btn btn-danger btn-sm">{{ __('Proceed')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
