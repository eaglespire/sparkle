        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('homepage.update')}}" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <textarea type="text" name="s8_body" rows="10" class="form-control">{{$ui->s8_body}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-12">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="card-img-actions d-inline-block mb-3">
                            <img class="img-fluid" src="{{asset('asset/images/'.$ui->s3_image)}}" alt="" class="blog-imaged">
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <div class="card-img-actions d-inline-block mb-3">
                            <img class="img-fluid" src="{{asset('asset/images/'.$ui->s4_image)}}" alt="" class="blog-imaged">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <div class="card-img-actions d-inline-block mb-3">
                            <img class="img-fluid" src="{{asset('asset/images/'.$ui->s7_image)}}" alt="" class="blog-imaged">
                        </div>
