          ...
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col-5 text-right">
                <a href="{{url('/')}}/user/reply-ticket/{{$val->id}}" class="btn btn-sm btn-neutral"><i class="fad fa-comment-dots"></i> {{__('Reply')}}</a>
                <a data-toggle="modal" data-target="#delete{{$val->id}}" href="" class="btn btn-sm btn-danger"><i class="fad fa-trash-alt"></i> {{__('Delete')}}</a>
              </div>
            </div>
            <div class="row">
              <div class="col">
