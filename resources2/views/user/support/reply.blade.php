          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-5 text-right">
                @if($ticket->status==0)
                  <a href="{{route('ticket.resolve', ['id'=>$ticket->id])}}" class="btn btn-sm btn-neutral"><i class="fad fa-thumbs-up"></i> {{__('Mark as Resolved')}}</a>
                @else
                  <span class="badge badge-pill badge-success"><i class="fad fa-check"></i> Resolved</span>
                @endif
              </div>
            </div>
          </div>
          ...
          <div class="card-body">
            ...
            @csrf
              ...
              <div class="text-right">
                <button type="submit" class="btn btn-neutral btn-block"><i class="fad fa-comment-dots"></i> {{__('Send Message')}}</button>
              </div>
            </form>
          </div>
        </div>
