      ...
      <div class="col-md-12">
        <div class="nav-wrapper2">
          <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch nav-trans b-b" id="tabs-icons-text" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.security')==url()->current()) active @endif" id="tabs-icons-text-2-tab" href="{{route('user.security')}}" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false">{{__('2fa & Password')}}</a>
            </li>
            <li class="nav-item">
              ...
              <div class="col-md-12">
                  ...
                  <div class="card-body">
                    <form action="{{route('user.account')}}" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                          <select class="form-control select" name="charges" required>
                            <option value="0" @if($user->charges==0) selected @endif>Charge me for the transaction fees</option>
                            <option value="1" @if($user->charges==1) selected @endif>Make customers pay the transaction fees</option>
                          </select>
                        </div>
                      </div>
                      @if($set->language==1)
                      ...
                      <div class="form-group row" id="payment_method">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="custom-control custom-control-alternative custom-checkbox">
                            <input type="checkbox" name="card" id=" customCheckLogin5" class="custom-control-input" value="1" @if($user->card==1) checked @endif>
                          ...
                          <div class="custom-control custom-control-alternative custom-checkbox">
                            <input type="checkbox" name="bank_account" id="customCheckLogin6" class="custom-control-input" value="1" @if($user->bank_account==1) checked @endif>
                          ...
                          <div class="custom-control custom-control-alternative custom-checkbox">
                            <input type="checkbox" name="mobile_money" id=" customCheckLogin7" class="custom-control-input" value="1" @if($user->mobile_money==1) checked @endif>
                      ...
                      <div class="form-group row" id="payment_method">
                        ...
                        <div class="col-lg-12">
                          <div class="custom-control custom-control-alternative custom-checkbox">
                            <input type="checkbox" name="email_receiver" id=" customCheckLogint" class="custom-control-input" value="1" @if($user->email_receiver==1) checked @endif>
                            <label class="custom-control-label" for=" customCheckLogint">
                              <span class="text-dark">{{__('Send me notification')}}</span>
                            </label>
                          </div><br>
                          <div class="custom-control custom-control-alternative custom-checkbox">
                            <input type="checkbox" name="email_sender" id="customCheckLoging" class="custom-control-input" value="1" @if($user->email_sender==1) checked @endif>
                ...
                <div class="card border-top-0">
                  <div class="card-header">
                    ...
                    <p>{{__('Closing this account means you will no longer be able to access this account on')}} {{$set->site_name}}</p>
                  </div>
                  <div class="card-footer">
                    <a data-toggle="modal" data-target="#modal-formp" href="" class="btn btn-neutral"><i class="fal fa-trash"></i> {{__('Delete Account')}}</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h3 class="mb-0 fw-bold">{{__('Delete Account')}}</h3>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-10">
                        <div class="input-group">
                          <input type="text" name="public_key" disabled class="form-control" placeholder="Public key" value="{{$user->public_key}}">
                          <div class="input-group-append">
                            <span class="input-group-text castro-copy" data-clipboard-text="{{$user->public_key}}" title="Copy to clipboard"><i class="fal fa-copy"></i></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-lg-10">
                        <div class="input-group">
                          <input type="password" name="secret_key" disabled class="form-control" placeholder="Secret key" value="{{$user->secret_key}}">
                          <div class="input-group-append">
                            <span class="input-group-text castro-copy" data-clipboard-text="{{$user->secret_key}}" title="Copy to clipboard"><i class="fal fa-copy"></i></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-10">
                        <div class="input-group">
                          <input type="text" name="public_key" disabled class="form-control" placeholder="Public key" value="{{$user->test_public_key}}">
                          <div class="input-group-append">
                            <span class="input-group-text castro-copy" data-clipboard-text="{{$user->test_public_key}}" title="Copy to clipboard"><i class="fal fa-copy"></i></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-lg-10">
                        <div class="input-group">
                          <input type="password" name="secret_key" disabled class="form-control" placeholder="Secret key" value="{{$user->test_secret_key}}">
                          <div class="input-group-append">
                            <span class="input-group-text castro-copy" data-clipboard-text="{{$user->test_secret_key}}" title="Copy to clipboard"><i class="fal fa-copy"></i></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <form action="{{route('savewebhook')}}" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                          <div class="input-group">
                            <input type="url" name="webhook" class="form-control" placeholder="https://webhook.site" value="{{$user->webhook}}">
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                          <div class="input-group">
                            <input type="text" name="webhook_secret" class="form-control" placeholder="" value="{{$user->webhook_secret}}">
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <div class="custom-control custom-control-alternative custom-checkbox">
                            <input type="checkbox" name="receive_webhook" id="customCheckLoginr8" class="custom-control-input" value="1" @if($user->receive_webhook==1)checked @endif>
              ...
              <div class="card-body">
                <div class="row align-items-center">
                  <div class="col-md-9">
                    ...
                    <p>Bank - {{getBankFirst($val->bank_name)}}</p>
