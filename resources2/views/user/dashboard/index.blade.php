...
<div class="container-fluid mt--6">
  <div class="content-wrapper mt-3">
    <h1 class="mb-3 text-dark fw-bold">{{__('Welcome')}} {{ucwords(strtolower($user->first_name))}}, 👋🏼</h1>
      ...
      <div class="card-body">
        <div class="row align-items-center">
          <div class="col-md-9 mb-2">
            <h2 class="mb-0 font-weight-bolder text-dark">{{__('Get a virtual card')}}</h2>
                    ...
                    <div class="col-md-6 col-12 mb-2">
                        <div class="media align-items-center">
                            <div class="media-body">
                                @if($user->live==1)
                                <h2 class="mb-0 text-dark font-weight-bolder">{{__('Balance')}}: {{number_format($user->getBalance($val->id)->amount,2).' '.$val->real->currency}}</h2>
                                @else
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group" id="old_beneficiary{{$val->id}}" style="display:none;">
                                            <select class="form-control" id="beneficiary{{$val->id}}" name="beneficiary">
                                              ...
                                              @foreach($user->getBeneficiary() as $ben)
                                                ...
                                                {{getBankFirst($ben->bank_name)}}-{{$ben->acct_no}}-{{$ben->acct_name}}
                                                @endif
                                                </option>
                                              @endforeach
                                            </select>
            ...
            <div class="card-body">
              <form action="{{route('swap.submit', ['id'=>$user->getBalance($val->id)->ref_id])}}" method="post" id="payment-form{{$val->id}}">
                ...
                <div class="form-group row">
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input type="number" name="from_amount" step="any" id="from_amount{{$val->id}}" value="{{$val->swap_min_amount}}" min="{{$val->swap_min_amount}}" max="{{$val->swap_max_amount}}" onkeyup="convert{{$val->id}}()" class="form-control form-control-lg fw-bold text-lg" required>
                    ...
                    <div class="col-lg-2 text-center mt-2 mb-2"><span><i class="fal fa-sync-alt fa-3x text-indigo"></i><br><br><span class="text-indigo" id="dd{{$val->id}}"></span></span></div>                   
                    <div class="col-lg-5">
                      <div class="input-group">
                        ...
                        <span class="input-group-append">
                          <select class="form-control select form-control-lg fw-bold text-lg" style="padding: 0.35rem 2rem 0.35rem;" id="rate{{$val->id}}" onclick="convertselect{{$val->id}}()"name="currency" required>
                            ...
                            <option value="{{$dal->id}}*{{$dal->rate}}*{{$dal->to_currency}}*{{$dal->getCurrency->real->currency}}">{{$dal->getCurrency->real->emoji.' '.$dal->getCurrency->real->currency}}</option>
                            @endforeach
                            @endif
                          </select>
                        </span>
          ...
          <div class="col-lg-10">
            <div class="input-group">
              ...
              <div class="input-group-append">
                <span class="input-group-text castro-copy" data-clipboard-text="{{$user->public_key}}" title="{{__('Copy to clipboard')}}"><i class="fal fa-copy"></i></span>
              </div>
            </div>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <div class="input-group">
              ...
              <div class="input-group-append">
                <span class="input-group-text castro-copy" data-clipboard-text="{{$user->secret_key}}" title="{{__('Copy to clipboard')}}"><i class="fal fa-copy"></i></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <div class="input-group">
              ...
              <div class="input-group-append">
                <span class="input-group-text castro-copy" data-clipboard-text="{{$user->test_public_key}}" title="{{__('Copy to clipboard')}}"><i class="fal fa-copy"></i></span>
              </div>
            </div>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <div class="input-group">
              ...
              <div class="input-group-append">
                <span class="input-group-text castro-copy" data-clipboard-text="{{$user->test_secret_key}}" title="{{__('Copy to clipboard')}}"><i class="fal fa-copy"></i></span>
              </div>
            </div>
          </div>
        </div>
